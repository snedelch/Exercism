...
export function remainingMinutesInOven(actualMinutesInOven) {
  var min_left = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
  return min_left;  
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  var min_to_cook = numberOfLayers * PREPARATION_MINUTES_PER_LAYER;
  return min_to_cook;
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  var total_time_cooked = preparationTimeInMinutes(numberOfLayers) + actualMinutesInOven;
